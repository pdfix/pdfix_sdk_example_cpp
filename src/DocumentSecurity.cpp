...
////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  void RemoveCustomSecurity(
    ...
    auto cipher_key = key;
    if (!doc->Authorize(kPermissionLevelUser, get_auth_data, &cipher_key)) {
      throw std::runtime_error(pdfix->GetError());
    }
  ...
  void PostponedDocumentAuthorization(
    ...
    auto get_auth_data = [](PdfDoc* doc, PdfSecurityHandler* handler, void* data) -> bool {
      ...
      if (filter == L"Standard") {
        ...
        std_handler->SetPassword(password, kPermissionLevelUser);
        return true;
      }
    ...
    if (doc->IsSecured() && !doc->Authorize(kPermissionLevelUser, get_auth_data, pass.data())) {
      throw std::runtime_error(pdfix->GetError());
    }
