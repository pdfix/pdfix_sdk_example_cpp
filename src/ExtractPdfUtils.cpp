...
void ExtractGraphicState(const PdfGraphicState& graphic_state,
                         ptree& node,
...
void RenderPageArea(PdfPage* page, PdfRect& bbox, ptree& node, const DataType& data_types) {
  ...
  auto page_view = std::unique_ptr<PdfPageView, decltype(page_view_deleter)>(
      page->AcquirePageView(data_types.render_zoom, data_types.render_rotate), page_view_deleter);
  if (!page_view)
...
std::string EncodeText(const std::wstring& text) {
  ...
  std::wstring replace[] = {L"<",  L"&#60;",  L">", L"&#62;",  L"&", L"&#38;",  L"\"", L"&#34;",
                            L"\\", L"&#39;",  L"�", L"&#162;", L"�", L"&#163;", L"�",  L"&#165;",
                            L"�",  L"&#128;", L"�", L"&#169;", L"�", L"&#174;", L"",   L""};
